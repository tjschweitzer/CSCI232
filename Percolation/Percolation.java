...
public class Percolation {
    ...
    private WeightedQuickUnionUF myOtherGrid; // Will be indexted 1, 0 is top and N*N+1 is bottom
   ...
   public void open(int row, int col) {
       if((checkIndex(row,col))){
          ...
          //if not top row checks if site above current is open
           if(row>0) {
