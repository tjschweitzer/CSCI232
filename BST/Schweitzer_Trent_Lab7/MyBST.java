  ...
  /*************************************************************************
    ...
    ***************************************************************************/
    ...
    public float getAvgDepth() {
        int tot = getTotalDepth(root,0);

        return (float)tot/size();
    }

    private int getTotalDepth(Node n ,int d) {
        if (n==null) {
            return 0;
        }
        return getTotalDepth(n.left, d+1)+getTotalDepth(n.right, d+1)+d;
...
//        String[] myString = {"B","A","C","D","E","F"};
//        for (int i = 0; i<myString.length; i++) {
//            
//            st.put(myString[i], i);
//        }
        Random rand = new Random() ;
        StdOut.println("n"+"\t"+"mean"+"\t \t \t"+"stddev");
          
        for (int n = 100; n <= 12800 ; n=n*2) {
            double[] ave= new double[1000];
            for (int i = 0; i < 1000; i++) {

                MyBST<Integer, Integer> pastaBst = new MyBST<Integer, Integer>();   
                for (int j = 0; j < n; j++) {
                    pastaBst.put(rand.nextInt(), j);
                }
                ave[i]= pastaBst.getAvgDepth();
//                StdOut.println(ave[i]);
            }
            StdOut.println(n+"\t"+StdStats.mean(ave)+"\t"+StdStats.stddev(ave));
        }
      
//        
//      StdOut.println(st.getAvgDepth());  
